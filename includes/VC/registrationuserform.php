          ...
          <div class="shopper-informations">
            ...
            <form action="#">
              ...
              <div class="row">
                ...
                <div class="col-sm-3">
                  <div class="shopper-info">
                    ...
                    <input type="text" placeholder="Nombre de Usuario (Apodo)"
                    ...
                    <input type="text" placeholder="Número de Documento del Usuario"
                      title="Número de Documento del Usuario" minlength="5" maxlength="30" required>
              ...
              <div class="d-flex justify-content-center mt-5">
                <div class="text-center p-1" title="He leído y acepto los Términos y Condiciones y la Política de Privacidad.">                  
                  <input type="checkbox" class="checkbox" > 
                  He leído y acepto los <a href="#" data-toggle="modal" data-target="#myModal">Términos y Condiciones y la Política de Privacidad.</a>
                  <!-- Modal Terms -->
            ...
            <div class="text-center">
              ...
              <a href="autenticacion.php" title="Iniciar Sesión"><i class="fa-solid fa-user-shield"></i> Iniciar Sesión</a>
            </div>
