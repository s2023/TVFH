            ...
            <div style="margin: auto;" class="col-sm-4 col-sm-offset-1">
              <div class="login-form">
                ...
                <form action="#"> 
                  ...
                  <input type="text" placeholder="Apodo o E-mail de Usuario" title="Apodo o E-mail de Usuario" required>
                
                  <!-- Form Password -->
                  <div class="row mt-3">
                    <div class="col-12">
                      <div class="d-flex" title="Contraseña de Usuario">
                        <i style="margin-right: 10px" class="fa-solid fa-user-lock" ></i><h6>Contraseña de Usuario</h6>
                      </div>
                    </div>
                  </div>
                  <input type="password" placeholder="Contraseña de Usuario" title="Contraseña de Usuario" required><br>
                ...
                <div class="text-center">                  
                  <a href="registro.php" title="Registro de Usuario"><i class="fa-solid fa-user-plus"></i> Registro de Usuario</a>
                </div>
