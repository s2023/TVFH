          ...
          <form action="#">
            ...
            <div class="card mb-4 p-5">
              <div class="shopper-informations">
                ...
                <div class="row mb-5">
                  ...
                  <div class="col-sm-3 ce-inforight">
                    <div class="bill-to"><br>
                      ...
                      <select title="Tipo de Usuario del sistema: Cliente o Administrador. No se puede modificar más adelante." required>
                ...
                <?php include_once 'includes/VA/usercreateformclientdata.php'?>
