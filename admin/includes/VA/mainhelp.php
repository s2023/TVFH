        ...
        <div class="container-fluid px-4">
          ...
          <div class="">
            ...
            <div class="review-payment text-center">
              <h2>Ayuda Administrador</h2>
            </div>
            <!-- Help Text-->
            <div class="row textovc p-3">
              <p>              
                <a href="#" title="Manual de Administrador - Tienda Virtual Florideas Holanda.pdf">
                  <i class="fas fa-file-pdf"></i> Manual de Administrador - Tienda Virtual Florideas Holanda
                </a><br><br>
            ...
            <!-- Start Help Login -->
            <!-- Help Login SubTitle -->
            <?php include_once 'includes/VA/helplogin.php'?>
            <!-- End Help Login -->
