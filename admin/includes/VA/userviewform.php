                ...
                <div class="row mb-5">
                  ...
                  <div class="col-sm-8">
                    <div class="bill-to">
                      ...
                      <div class="form-one">
                        ...
                        <input type="email" placeholder="E-mail del Usuario" title="E-mail del Usuario. Correo electrónico del usuario registrado en la tienda." maxlength="60" value="correo@correo.com" required disabled>
                        ...
                        <input type="password" placeholder="Contraseña"
                          ...
                          minlength="6" maxlength="15" value="Contraseña" required disabled>
                      ...
                      <div class="form-two">
                        ...
                        <input type="text" placeholder="Nombres del Usuario" title="Nombres del usuario registrado en la tienda." maxlength="50" value="Nombres del Usuario" required disabled>
                        ...
                        <input type="text" placeholder="Apellidos del Usuario" title="Apellidos del Usuario registrado en la tienda." maxlength="50" value="Apellidos del Usuario" required disabled>
                        ...
                        <select title="Tipo de documento de identidad del usuario registrado en la tienda." value="1" required disabled>
                          <!-- <option >
                        ...
                        <input type="text" placeholder="Número de Documento del Usuario" title="Número de Documento del Usuario registrado en la tienda."
                          minlength="5" maxlength="30" value="9999999999" required disabled>
                  ...
                  <div class="col-sm-3 ce-inforight">
                    <div class="bill-to"><br>
                      ...
                      <select title="Estado actual del usuario: Activado, Desactivado, Eliminado." required disabled>
