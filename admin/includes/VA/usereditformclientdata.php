                <!-- Start Row 2 Form User Client Data Inputs (!!!Form Client que se habilita en selector estado usuario y datos de cliente en pedido) -->
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    <div class="bill-to">
                      ...
                      <div class="form-one">
                        ...
                        <select title="Tipo de documento de identidad de la persona a cargo de la facturación del pedido." required>
                        ...
                        <input type="text" placeholder="Número de Documento de Facturación"
                          title="Número de documento de identidad de la persona a cargo de la facturación del pedido." minlength="5" maxlength="30" value="9999999999" required>
                      ...
                      <div class="form-two">
                        ...
                        <input type="tel" placeholder="Teléfono de Facturación" title="Número de teléfono de la persona a cargo de la facturación del pedido." minlength="5"
                          maxlength="20" value="999-999-999" required>
                        ...
                        <select title="País de la persona a cargo de la facturación del pedido." value="" required>
                        ...
                        <select title="Departamento/Provincia/Región de la persona a cargo de la facturación del pedido." value="" required>
                        ...
                        <select title="Ciudad de la persona a cargo de la facturación del pedido." value="" required>
                  ...
                  <div class="col-sm-3 ce-inforight">
                    <div class="bill-to">
                      ...
                      <input type="text" placeholder="Nombres de Envío" title="Nombres de la persona a la cual se le va a enviar del pedido." maxlength="50" value="Nombres de Envío" required>
                      ...
                      <input type="text" placeholder="Apellidos de Envío" title="Apellidos de la persona a la cual se le va a enviar del pedido." maxlength="50" value="Apellidos de Envío" required>
                      ...
                      <input type="text" placeholder="Dirección de Envío" title="Dirección de la persona a la cual se le va a enviar del pedido." maxlength="60" value="Dirección de Envío" required>
                      ...
                      <select required title="País de la persona a la cual se le va a enviar del pedido." value="">
                      ...
                      <select required title="Departamento/Provincia/Región de la persona a la cual se le va a enviar del pedido." value="">
                      ...
                      <select required title="Ciudad de la persona a la cual se le va a enviar del pedido." value="">
